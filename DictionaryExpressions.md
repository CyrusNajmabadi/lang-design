...
The support for spreads only being concerned with  element types (and not the collection type being spread itself), matches the equivalent cases in the collection-expression case, such as:
